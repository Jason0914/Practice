...
<body>
	...
	<div class="left-section">
		<div>
			...
			<h3>品牌故事</h3>
			<p>在 Coffee
				Soufflé，我們相信每一刻都值得細細品味。懷著對濃郁芳香的咖啡和輕盈蓬鬆的舒芙蕾的熱愛，我們創立了這個品牌，致力於為顧客打造難忘的味覺體驗。從甄選最優質的咖啡豆，到使用新鮮的食材製作舒芙蕾，每一個細節都展現了我們對卓越品質的追求。</p>
			<h3>創辦人的話</h3>
			<p>「Coffee Soufflé
				的誕生，源自於我希望透過簡單卻非凡的風味，為人們的生活帶來一點幸福。我想要創造一個地方，讓每一杯咖啡、每一口舒芙蕾都能像溫暖的擁抱一般，治癒心靈。感謝您成為我們旅程的一部分——是您們的笑容和滿意，讓我們每天都不斷創新與進步。」– Jason
				</p>
		...
		<div class="container-xl">
			<div class="row">
				<div class="col-12 member mb-5">
					...
					<div class="login mx-auto animate__animated animate__zoomIn">
						<form id="loginForm">
							<fieldset>
								...
								<p>
									還不是夥伴嗎？<a href="#" id="toRegister">點我加入</a>
								</p>
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control account"
										id="loginAccount" name="loginAccount" placeholder="account">
								</div>
								...
								<div class="input-group mb-3">
									...
									<div class="password-eye">
										<input type="password"
											class="form-control password login-password"
											id="loginPassword" name="loginPassword"
											placeholder="password">
										<div class="password-eye-append">
											<span class="passwordToggle" id="passwordToggle"> <i
												class="fa fa-eye d-none"></i> <i class="fa fa-eye-slash"></i>
											</span>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div>
										<input id="myvad" class="form-control mb-3" type="text"
											name="vad" placeholder="請輸入驗證碼">
									</div>
								</div>
								<!-- 圖片驗證 -->
								<p>
									<a href="#" id="toForget">忘記密碼</a>
								</p>

								<button type="button" id="loginButton"
									class="btn btn-primary d-flex mx-auto"
									onclick="/member_backend">登入</button>
					...
					<!-- register -->
					<div
						class="register mx-auto my-5 d-none animate__animated animate__zoomIn">
						<form id="createMember"
							...
							<fieldset>
								...
								<p>
									已經是夥伴了嗎？<a href="#" id="toLogin">點我登入</a>
								</p>
								<!-- 帳號 -->
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										<div class="input-group">
											...
											<input type="text" class="form-control account" id="account"
												name="account" placeholder="account" required>
										</div>
										<div id="accountError" class="invalid-feedback"
											style="display: none;">此帳號已被註冊。</div>
									</div>
								</div>
								<!-- 密碼 -->
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										<div class="input-group mb-3">
											...
											<div class="password-eye">
												<input type="password"
													class="form-control password registerPassword"
													id="password" name="password" placeholder="password"
													pattern="^(?=.*[a-zA-Z])(?=.*[0-9]).{6,}$" required />
												<div class="password-eye-append">
													<span class="passwordToggle" id="passwordToggle1"> <i
														class="fa fa-eye d-none"></i> <i class="fa fa-eye-slash"></i>
													</span>
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										<div class="input-group mb-3">
											...
											<div class="password-eye">
												<input type="password"
													class="form-control password registerPassword2"
													id="password2" name="password2" placeholder="password"
													pattern="^(?=.*[a-zA-Z])(?=.*[0-9]).{6,}$" required />
												<div class="password-eye-append">
													<span class="passwordToggle" id="passwordToggle2"> <i
														class="fa fa-eye d-none"></i> <i class="fa fa-eye-slash"></i>
													</span>
												</div>
											</div>
									...
									<div class="col-12 col-sm-8">
										<div class="mb-3">
											<input class="form-check-input" type="radio" name="gender"
												id="genderMale" value="男生" checked> <label
												class="form-check-label" for="genderMale"><i
												class="fa fa-mars"></i>男生</label> <input class="form-check-input"
												type="radio" name="gender" id="genderFemale" value="女生">
											<label class="form-check-label" for="genderFemale"><i
												class="fa fa-venus"></i>女生</label>
										</div>
									</div>
								</div>
								<!-- 生日 -->
								...
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										...
										<div id="emailError" class="invalid-feedback"
											style="display: none;">此Email已被使用。</div>
									</div>
								</div>
								<!-- 手機號碼 -->
								<div class="row">
									...
									<div class="col-12 col-sm-8">
										<div class="input-group">
											...
											<input type="tel" class="form-control" id="phone"
												...
												maxlength="10" pattern="09\d{2}\d{6}"
												oninput="setCustomValidity('');"
												oninvalid="setCustomValidity('請輸入正確的手機號碼格式:09xxxxxxxx');" />
										</div>
										<div id="phoneError" class="invalid-feedback"
											style="display: none;">此手機號碼已被使用。</div>
									</div>
								</div>
								<button type="submit" id="registerButton"
									class="btn btn-primary d-flex mx-auto">加入夥伴</button>
							</fieldset>
						</form>
					</div>
					<!-- register -->
					...
					<!-- forget -->
					<div
						class="forget mx-auto d-none animate__animated animate__zoomIn">
						<form id="forgetForm">
							<fieldset>
								<h2>
									<i class=" "></i> 忘記密碼
								...
								<p>
									想到密碼了？<a href="#" id="toLoginFromForget">回登入頁面</a>
								</p>
								...
								<div class="input-group mb-3">
									...
									<input type="email" class="form-control" id="forgetEmail"
										name="forgetEmail" placeholder="email@example.com" required
										pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" />
								</div>
								<div id="changeMailError" class="invalid-feedback"
									style="display: none;">沒有此Email。</div>
								<button type="button" id="forgetButton"
									class="btn btn-primary d-flex mx-auto mb-3">傳送驗證碼</button>
								<button type="button" id="changeButton"
									class="btn btn-primary d-flex mx-auto" data-bs-toggle="modal"
									data-bs-target="#changePasswordModal">變更密碼</button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form id="updateMemberForm" method="PUT"
										enctype="multipart/form-data">
										<!-- HttpMethod 隱藏欄位 -->
										<input type="hidden" class="form-control" id="memberId"
											name="memberId"> <input name="_method" type="hidden"
											value="PUT" />
										<fieldset>
											<!-- 電子郵件 -->
											...
											<div id="passwordFields" style="display: none;">
												...
												<div class="input-group mb-3">
													...
													<div class="password-eye">
														<input type="password" class="form-control newPassword2"
											...
											<div class="modal-button my-3 text-center">
												...
												<button type="button" class="btn btn-outline-primary me-3"
													id="verifyCodeButton">驗證</button>
												<button type="button" id="updateButton"
													class="btn btn-outline-primary ms-3" style="display: none;">修改密碼</button>
											</div>
										</fieldset>
									</form>
								</div>
